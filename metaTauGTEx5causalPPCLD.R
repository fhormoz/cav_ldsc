...
for (tissue in BedFiles) {
	...
	list_trait = Sys.glob(paste0(paste("/groups/price/farhad/Results/LDSC_eQTL_GTEx_CAVIAR_5casaul_v6_7Nov2016_LD/eQTL_CAVIAR_GTEx_v6_5causal/", tissue,sep="/"), "/*.log"));
